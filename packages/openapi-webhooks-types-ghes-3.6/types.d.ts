...
export interface components {
  schemas: {
    ...
    "dependency-graph-diff": {
      ...
      name: string;
      version: string;
      package_url: OneOf<[string, null]>;
      license: OneOf<[string, null]>;
      source_repository_url: OneOf<[string, null]>;
      vulnerabilities: {
        severity: string;
    ...
    "group-response": {
      ...
      externalId?: OneOf<[string, null]>;
      /** @description A human-readable name for a security group. */
      displayName?: OneOf<[string, null]>;
